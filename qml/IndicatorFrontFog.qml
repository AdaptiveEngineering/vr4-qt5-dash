...
Item {
    ...
    function paintIcon(ctx, color) {
        ...
        ctx.beginPath();
        ctx.moveTo(0.4 * width, 0.25 * height);
        ctx.lineTo(0.04 * width, 0.44 * height);
        ctx.stroke();

        ctx.beginPath();
        ctx.moveTo(0.4 * width, 0.44 * height);
        ctx.lineTo(0.04 * width, 0.62 * height);
        ctx.stroke();

        ctx.beginPath();
        ctx.moveTo(0.4 * width, 0.62 * height);
        ctx.lineTo(0.04 * width, 0.82 * height);
        ctx.stroke();
